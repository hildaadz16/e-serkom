    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($b->diskon); ?>%</td> <!-- Tampilkan diskon sebagai persentase -->
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>

    <a href="/" class="btn btn-secondary">Kembali</a> <!-- Tombol kembali -->
</div>

</body>
</html>
<?php /**PATH F:\apa aja yang penting kuliah\example-app\resources\views/hotel/booking.blade.php ENDPATH**/ ?>